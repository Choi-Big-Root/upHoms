...
class _PropertyDto implements PropertyDto {
  const _PropertyDto({this.propertyId = '', this.propertyName = '', this.propertyDescription = '', this.mainImage = '', this.propertyLocation = '', this.propertyAddress = '', this.isDraft = false, this.user = const UserDto(), this.propertyNeighborhood = '', this.ratingSummary = 0.0, this.price = -1, this.taxRate = 0.0, this.cleaningFee = -1, this.notes = '', this.minNightStay = 0.0, this.lastUpdated = '', this.minNights = -1, this.isLive = false});
