...
mixin _$ReviewDto {
 ...
 int get reviewId; int get tripId; int get propertyId; UserDto get user; double get rating; String get ratingDescription; String get ratingCreated;
...
@override
String toString() {
  return 'ReviewDto(reviewId: $reviewId, tripId: $tripId, propertyId: $propertyId, user: $user, rating: $rating, ratingDescription: $ratingDescription, ratingCreated: $ratingCreated)';
}
...
@useResult
$Res call({
 int reviewId, int tripId, int propertyId, UserDto user, double rating, String ratingDescription, String ratingCreated
});
...
/// Create a copy of ReviewDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? reviewId = null,Object? tripId = null,Object? propertyId = null,Object? user = null,Object? rating = null,Object? ratingDescription = null,Object? ratingCreated = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int reviewId,  int tripId,  int propertyId,  UserDto user,  double rating,  String ratingDescription,  String ratingCreated)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReviewDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int reviewId,  int tripId,  int propertyId,  UserDto user,  double rating,  String ratingDescription,  String ratingCreated)  $default,) {final _that = this;
switch (_that) {
case _ReviewDto():
return $default(_that.reviewId,_that.tripId,_that.propertyId,_that.user,_that.rating,_that.ratingDescription,_that.ratingCreated);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int reviewId,  int tripId,  int propertyId,  UserDto user,  double rating,  String ratingDescription,  String ratingCreated)?  $default,) {final _that = this;
switch (_that) {
case _ReviewDto() when $default != null:
return $default(_that.reviewId,_that.tripId,_that.propertyId,_that.user,_that.rating,_that.ratingDescription,_that.ratingCreated);case _:
  return null;
...
class _ReviewDto implements ReviewDto {
  const _ReviewDto({this.reviewId = -1, this.tripId = -1, this.propertyId = -1, this.user = const UserDto(), this.rating = 0.0, this.ratingDescription = '', this.ratingCreated = ''});
...
/// Create a copy of ReviewDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? reviewId = null,Object? tripId = null,Object? propertyId = null,Object? user = null,Object? rating = null,Object? ratingDescription = null,Object? ratingCreated = null,}) {
